...
# redis 使用RedisTemplate访问Redis数据结构  spirng data redis

/Users/jerryye/backup/studio/AvailableCode/database/NoSQL/redis/spring-boot-redis
...
### 通用二进制序列化 RedisTemplate配置 默认jdk

通用RedisTemplate配置如下： 

```java
    /**
     * <B>Description:</B> 实例化 RedisTemplate <br>
     * <B>Create on:</B> 2018/4/14 上午11:38 <br>
     *
     * @author xiangyu.ye
     */ 
    @Bean
...
### string序列化 RedisTemplate配置 

Redis的String数据结构 （推荐使用StringRedisTemplate） 直接使用自带 的类 StringRedisTemplate, 
